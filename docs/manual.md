...
!!! warning
    ...
    Unlike other formats, person and entity merging heuristics are not implemented for CodeMeta.
    The author, maintainer, and contributor fields are directly created from your somesy project
    metadata, overwriting any existing entries in these fields.
