...
# PEP 508 / PEP 503: names are ASCII letters, digits, and ".", "-", "_".
# They must start and end with a letter or digit.
PEP508_NAME_PATTERN = r"^([A-Za-z0-9]|[A-Za-z0-9][A-Za-z0-9._-]*[A-Za-z0-9])$"
...
class PoetryConfig(BaseModel):
    ...
    name: Annotated[
        str,
        Field(pattern=PEP508_NAME_PATTERN, description="Package name"),
    ]
    version: Annotated[
        str | None,
        Field(
...
class Pep621Config(BaseModel):
    ...
    name: Annotated[str, Field(pattern=PEP508_NAME_PATTERN)]
    version: Annotated[
        str | None,
        Field(
            default=None,
